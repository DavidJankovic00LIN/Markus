      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-14 items-start">
          ...
          <div className="flex flex-col items-center md:items-start gap-6 sm:gap-8">
            ...
            <div
              ref={address.ref}
              className={`flex items-center gap-4 sm:gap-5 transition-transform duration-700 ease-out transform-gpu ${
                address.inView
                  ? 'opacity-100 rotate-y-0'
                  : 'opacity-0 translate-y-4 rotate-y-90'
              }`}
            >
              <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-brand rounded-full flex items-center justify-center shadow-md backface-hidden">
              <svg
            ...
            <div
              ref={email.ref}
              className={`flex items-center gap-4 sm:gap-5 transition-transform duration-700 ease-out delay-100 transform-gpu ${
                email.inView
                  ? 'opacity-100 rotate-y-0'
                  : 'opacity-0 translate-y-4 rotate-y-90'
              }`}
            ...
            <div
              ref={phone.ref}
              className={`flex items-center gap-4 sm:gap-5 transition-transform duration-700 ease-out delay-200 transform-gpu ${
                phone.inView
                  ? 'opacity-100 rotate-y-0'
                  : 'opacity-0 translate-y-4 rotate-y-90'
              }`}
